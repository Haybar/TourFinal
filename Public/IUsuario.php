...
<body>
	...
	<section class="help-section-text spad">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<p>Llajta Tour es un proyecto destinado a brindar información detallada sobre los atractivos turisticos de la hermosa ciudad de Cochabamba y ademas de poder incentivar a las personas a conocer su propia ciudad</p>
				</div>
				<div class="col-md-6">
					<p>Es así que Llajta Tour nace de una idea para poder dar a los turistas una mejor estancia al visitar esta ciudad, queremos promocionar y dar un apoyo a las personas que quieran visitar y conocer mas acerca de la cultura que destaca en este departamento. Llajta Tour te brinda informacion sobre: </p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<ul class="help-list">
						<li>Informacion Confiable</li>
				...
				<div class="col-md-4">
					<ul class="help-list">
						<li>Gastronomia</li>
						<li>Actividades</li>
						<li>Atractivos Naturales</li>
						<li>Atractivos Historicos</li>
					</ul>
				</div>
				<div class="col-md-4">
					<ul class="help-list">
