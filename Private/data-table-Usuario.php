...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="home.php"><img src="images/logoBC.png"></a>
                  ...
                  <tbody>
                    ...
                    ?>
                          <tr>
                            ...
                            <td><img src="Upload/<?php echo $row['fotoUsuario']; ?>" style="width: 100px"></td>
