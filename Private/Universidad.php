        ...
        <div class="col-lg-12">
            <div class="bs-component">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item"><a class="nav-link "  href="data-table-Universidad.php">Tabla</a></li>
                <li class="nav-item"><a class="nav-link active"  href="Universidad.php">Registro</a></li>
              </ul>
            </div>
          </div>
      </div>
