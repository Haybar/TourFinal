        ...
        <div class="col-md-8">
          <div class="tile">
            <div class="tile-body">
              ...
              ?>
              <form class="for-balneario" action="modificarUniversidadbd.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="exampleSelect1" name="categoria" value="<?php echo $categoria;?>">
                        <?php
                          $query = $mysqli -> query ("SELECT * FROM Categoria WHERE idCategoria='9'");
                ...
                <div class="tile-footer" align=center>
                  <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Guardar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="data-table-Universidad.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                </div>
              </form>
            </div>
          </div>
