    ...
    <main class="app-content">
        ...
        <div class="col-lg-12">
            <div class="bs-component">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item"><a class="nav-link " href="data-table-Institucion.php">Tabla</a></li>
                <li class="nav-item"><a class="nav-link active"  href="Institucion.php">Registro</a></li>
              </ul>
            </div>
          </div>
      </div>
      <div class="row">
        <div class="col-md-8">
          <div class="tile">
            <div class="tile-body">
              <form class="for-balneario" action="registrarInstitucionbd.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="exampleSelect1" name="categoria">
                        ...
                        <?php
                          $query = $mysqli -> query ("SELECT * FROM Categoria WHERE idCategoria='10'");
                ...
                <div class="tile-footer" align=center>
                  <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Agregar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="data-table-Institucion.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                </div>
              </form>
            </div>
          </div>
