        ...
        <div class="col-lg-12">
            <div class="bs-component">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item"><a class="nav-link active"  href="data-table-Institucion.php">Tabla</a></li>
                <li class="nav-item"><a class="nav-link"  href="Institucion.php">Registro</a></li>
              </ul>
            </div>
          </div>
      </div>
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <?php
                    include ("config.php");
                      $sql="SELECT idLugar,foto,nombreLugar,descripcion,direccion,horarioAtencion FROM `Lugar` WHERE Categoria_idCategoria='10' AND estado='1';";
                    ...
                    ?>
                          <tr>
                            ...
                            <td>
                              <div class="row">
                                <div class="col-md-3">
                                  <form action="InstitucionEditarForm.php" method="POST">
