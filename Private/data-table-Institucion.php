        ...
        <div class="col-lg-12">
            <div class="bs-component">
              <ul class="nav nav-tabs">
                <li class="nav-item"><a class="nav-link active"  href="data-table-Institucion.php">Inicio</a></li>
                <li class="nav-item"><a class="nav-link"  href="Institucion.php">Profile</a></li>
              </ul>
            </div>
          </div>
      </div>
