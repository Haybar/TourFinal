        ...
        <div class="col-md-8">
          <div class="tile">
            <div class="tile-body">
              ...
              ?>
              <form class="for-balneario" action="modificarBalneariobd.php" method="POST"  enctype="multipart/form-data">
                ...
                <div class="tile-footer" align=center>
                  <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Guardar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="data-table-Balneario.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                </div>
              </form>
            </div>
          </div>
