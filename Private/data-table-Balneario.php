              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <?php
                    include ("config.php");
                      $sql="SELECT idLugar,foto,nombreLugar,descripcion,direccion,horarioAtencion FROM `Lugar` WHERE Categoria_idCategoria='1' AND estado='1';";
                    ...
                    ?>
                          <tr>
                            ...
                            <td>
                              <div class="row">
                                <div class="col-md-3">
                                  <form action="BalnearioEditarForm.php" method="POST">
