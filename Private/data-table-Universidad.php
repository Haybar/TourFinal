        ...
        <div class="col-lg-12">
            <div class="bs-component">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item"><a class="nav-link active" href="data-table-Universidad.php">Tabla</a></li>
                <li class="nav-item"><a class="nav-link"  href="Universidad.php">Registro</a></li>
              </ul>
            </div>
          </div>
      </div>
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    <?php
                    include ("config.php");
                      $sql="SELECT idLugar,foto,nombreLugar,descripcion,direccion,horarioAtencion FROM `Lugar` WHERE Categoria_idCategoria='9' AND estado='1';";
